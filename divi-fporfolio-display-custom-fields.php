<?php
/*
Plugin Name: Divi Filterable Portfolio Display Custom Fields
Plugin URI:  https://github.com/opshope
Description: Display the "Title" and "Company" custom fields underneath every Filterable Portfolio entry.
Version:     1.0
Author:      Joshua Simon
Author URI:  https://github.com/opshope
License:     GPL3
License URI: https://www.gnu.org/licenses/gpl-3.0.html
Text Domain: divi-fporfolio-display-custom-fields
*/

function divi_child_theme_setup() {
  if ( class_exists('ET_Builder_Module')) {

    class CHILD_ET_Builder_Module_Filterable_Portfolio extends ET_Builder_Module {
      function init() {
      ...
      function get_fields() {
        $fields = array(
          ...
          'show_categories' => array(
            'label'             => esc_html__( 'Show Company and Job Title', 'et_builder' ),
            'type'              => 'yes_no_button',
            'option_category'   => 'configuration',
            'options'           => array(
              'on'  => esc_html__( 'Yes', 'et_builder' ),
...
<?php
    ...
    $cgm = new CHILD_ET_Builder_Module_Filterable_Portfolio();
    remove_shortcode( 'et_pb_portfolio' );
    add_shortcode( 'et_pb_portfolio', array($cgm, '_shortcode_callback') );
  }
}
